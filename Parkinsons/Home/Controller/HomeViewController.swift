...
//        TherapeuticGameModel(title: "Match the Cards", description: "Complete your daily challenge!", iconName: "brain")
//    ]
//    
...
class HomeViewController: UIViewController, UICollectionViewDelegate {
    ...
    var therapeuticGamesData: [TherapeuticGameModel] = [
        TherapeuticGameModel(title: "Mimic the Emoji", description: "Complete your daily challenge!", iconName: "face.smiling.fill"),
        TherapeuticGameModel(title: "Match the Cards", description: "Complete your daily challenge!", iconName: "brain.fill")
    ]
