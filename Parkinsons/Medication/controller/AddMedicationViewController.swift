...
//   • Strength field: numeric keyboard, rejects 0 and negative, blocks non-digit input
//   • Unit field moved to UnitAndTypeViewController (see that file for dropdown)
//   • Calls MedicationNotificationManager.rescheduleAll() after save and delete
...
class AddMedicationViewController: UIViewController,
    ...
    func fillFieldsForEditing() {
        ...
        // Show positive strength only (never show 0)
    ...
    private func evaluateTickButtonState() {
        ...
        // Also validate strength > 0 in edit mode before enabling tick
        let strengthValue = Int(strengthLabel.text ?? "") ?? 0
