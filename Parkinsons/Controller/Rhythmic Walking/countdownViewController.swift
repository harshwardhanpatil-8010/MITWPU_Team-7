...
////            let vc = storyboard.instantiateViewController(withIdentifier: "SessionRunningVC") as! SessionRunningViewController
////  
...
//        vc.currentIndex = startingIndex
//        
//        // Important: push only if inside a navigation controller
